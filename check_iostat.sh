...
#
# Version 0.0.8 - Jun/2015
# Changes:
# - Fixed performance data to be compliant for pnp4nagios and Splunk
#
# by Luke Harris / skywalka@gmail.com
#
...
exit $status
#----------/check_iostat.sh-----------
Version for Ubuntu 12.04/systat 10.0.3.1bybenjfield, July 14, 2014
